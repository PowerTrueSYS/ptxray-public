...
AIXRAY_TOOL=ck-fileperm-atjobs-group


function standalone_check {
_AIXRAY_SESSION_KEYS=""
  # fileperm_atjobs_group — DISA STIG V-245567.
  # This unit shares the fixed-directory capture key with the owner/mode units.
  ...
  if [ -n "$FPA_REASON" ]; then
    ...
    add security fileperm_atjobs_group "Atjobs directory group" PASS med \
        "/var/spool/cron/atjobs group=8 (cron)" \
        "/var/spool/cron/atjobs is group-owned by cron as required by DISA STIG V-245567." \
        "n/a" "stig:V-245567"
  else
    FPA_GROUP_OBSERVED="/var/spool/cron/atjobs group=$FPA_GID"
