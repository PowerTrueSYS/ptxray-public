...
_AIXRAY_SESSION_KEYS=""
  # fileset_state — broken filesets block future updates. Parse the colon-delimited
  # 'lslpp -qcL' inventory (one line per fileset) rather than columnar 'lslpp -L',
  # whose Description column wraps long entries onto continuation lines. Colon fields:
