...
AIXRAY_TOOL=ck-lv-mirror-placement
...
# Shared physical-memory capture used by standalone storage-layout judgments.
function capture_cap_prtconf {
  PRTCONF=$(aix prtconf prtconf); PRTCONF_RC=$?
  [ "$PRTCONF_RC" -eq 0 ] || PRTCONF=""
